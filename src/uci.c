...
void uci_loop() {
    ...
    while (fgets(line, sizeof(line), stdin)) {
        ...
        if (strcmp(line, "uci") == 0) {
            ...
            printf("option name LMP_Base type spin default 7 min 1 max 20\n");
            ...
            printf("option name Futility_Margin type spin default 247 min 50 max 400\n");
            printf("option name Futility_MarginD2 type spin default 277 min 100 max 600\n");
            printf("option name Futility_MarginD3 type spin default 447 min 150 max 800\n");
            printf("option name RFP_Margin type spin default 92 min 50 max 300\n");
            printf("option name RFP_MaxDepth type spin default 9 min 2 max 10\n");
            printf("option name Razor_Margin type spin default 313 min 100 max 600\n");
            printf("option name Delta_Margin type spin default 200 min 50 max 500\n");
            printf("option name Aspiration_Window type spin default 106 min 10 max 200\n");
            printf("option name Hist_BonusMult type spin default 441 min 50 max 800\n");
            printf("option name Hist_BonusSub type spin default 259 min 0 max 1000\n");
            printf("option name Hist_BonusMax type spin default 5398 min 500 max 16000\n");
            printf("option name Hist_MalusMult type spin default 951 min 100 max 4000\n");
            printf("option name Hist_MalusSub type spin default 414 min 0 max 2000\n");
            printf("option name Hist_MalusMax type spin default 1311 min 500 max 16000\n");
            printf("option name FMH_Weight type spin default 132 min 0 max 256\n");
            printf("option name LMR_StatLow2 type spin default -32325 min -49000 max 0\n");
            printf("option name LMR_StatLow1 type spin default -2704 min -49000 max 0\n");
            printf("option name LMR_StatHigh1 type spin default 23801 min 0 max 49000\n");
            printf("option name LMR_StatHigh2 type spin default 14575 min 0 max 49000\n");
