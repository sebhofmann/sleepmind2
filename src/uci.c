...
void uci_loop() {
    ...
    while (fgets(line, sizeof(line), stdin)) {
        ...
        if (strcmp(line, "uci") == 0) {
            ...
            printf("option name LMR_FullDepthMoves type spin default 4 min 1 max 10\n");
            printf("option name LMR_ReductionLimit type spin default 3 min 1 max 6\n");
            printf("option name NullMove_Reduction type spin default 5 min 1 max 5\n");
            printf("option name NullMove_MinDepth type spin default 2 min 1 max 6\n");
            printf("option name Futility_Margin type spin default 157 min 50 max 400\n");
            printf("option name Futility_MarginD2 type spin default 116 min 100 max 600\n");
            printf("option name Futility_MarginD3 type spin default 416 min 150 max 800\n");
            printf("option name RFP_Margin type spin default 81 min 50 max 300\n");
            printf("option name RFP_MaxDepth type spin default 4 min 2 max 10\n");
            printf("option name Razor_Margin type spin default 143 min 100 max 600\n");
            printf("option name Delta_Margin type spin default 200 min 50 max 500\n");
            printf("option name Aspiration_Window type spin default 35 min 10 max 200\n");
            printf("option name Hist_BonusMult type spin default 620 min 50 max 800\n");
            printf("option name Hist_BonusSub type spin default 314 min 0 max 1000\n");
            printf("option name Hist_BonusMax type spin default 4119 min 500 max 16000\n");
            printf("option name Hist_MalusMult type spin default 877 min 100 max 4000\n");
            printf("option name Hist_MalusSub type spin default 667 min 0 max 2000\n");
            printf("option name Hist_MalusMax type spin default 2941 min 500 max 16000\n");
            printf("option name FMH_Weight type spin default 169 min 0 max 256\n");
            printf("option name LMR_StatLow2 type spin default -27517 min -49000 max 0\n");
            printf("option name LMR_StatLow1 type spin default -7379 min -49000 max 0\n");
            printf("option name LMR_StatHigh1 type spin default 16538 min 0 max 49000\n");
            printf("option name LMR_StatHigh2 type spin default 29404 min 0 max 49000\n");
            printf("uciok\n");
            fflush(stdout);
