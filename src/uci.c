...
void uci_loop() {
    ...
    while (fgets(line, sizeof(line), stdin)) {
        ...
        if (strcmp(line, "uci") == 0) {
            ...
            printf("option name LMR_FullDepthMoves type spin default 2 min 1 max 10\n");
            printf("option name LMP_Base type spin default 5 min 1 max 20\n");
            printf("option name LMP_MaxDepth type spin default 7 min 1 max 12\n");
            ...
            printf("option name Futility_Margin type spin default 210 min 50 max 400\n");
            printf("option name Futility_MarginD2 type spin default 251 min 100 max 600\n");
            printf("option name Futility_MarginD3 type spin default 421 min 150 max 800\n");
            printf("option name RFP_Margin type spin default 78 min 50 max 300\n");
            ...
            printf("option name Hist_BonusMult type spin default 455 min 50 max 800\n");
            printf("option name Hist_BonusSub type spin default 254 min 0 max 1000\n");
            printf("option name Hist_BonusMax type spin default 4506 min 500 max 16000\n");
            printf("option name Hist_MalusMult type spin default 734 min 100 max 4000\n");
            printf("option name Hist_MalusSub type spin default 541 min 0 max 2000\n");
            printf("option name Hist_MalusMax type spin default 2175 min 500 max 16000\n");
            printf("option name FMH_Weight type spin default 132 min 0 max 256\n");
            printf("option name LMR_StatLow2 type spin default -26364 min -49000 max 0\n");
            printf("option name LMR_StatLow1 type spin default -2720 min -49000 max 0\n");
            printf("option name LMR_StatHigh1 type spin default 20958 min 0 max 49000\n");
            printf("option name LMR_StatHigh2 type spin default 15224 min 0 max 49000\n");
