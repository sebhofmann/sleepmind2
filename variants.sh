...
create_variant() {
    ...
    if [ -z "$name" ]; then
        ...
        echo "  RFP_ImprovingAdjustment=<0-300>"
...
case "${1:-}" in
    ...
    *)
        ...
        echo "                    Use_DeltaPruning, Use_Aspiration, Use_Razoring (=true/false)"
        ...
        echo "                    Futility_MarginD3 (150-800)"
        echo "  RFP:              RFP_Margin (50-300), RFP_ImprovingAdjustment (0-300), RFP_MaxDepth (2-10)"
